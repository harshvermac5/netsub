...
def generate_eui64_address():
    ...
    result_label.config(text=f"The generated IPv6 address is: {ipv6_address}")
...
Label(window, text="Global Routing Prefix:").grid(row=0, column=0, padx=10, pady=10)
Label(window, text="MAC Address:").grid(row=1, column=0, padx=10, pady=10)
